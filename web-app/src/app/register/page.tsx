...
import { Button, Divider, Field, FluentProvider, Input, Label, Link, Radio, RadioGroup, webLightTheme } from "@fluentui/react-components";
        ...
        <FluentProvider theme={webLightTheme}>
            <main className="min-h-screen flex flex-grow items-center justify-center p-8">
                <div className="flex rounded-3xl shadow-2xl p-8 justify-center items-center flex-col">
                    <Label size="large" className="p-2">Đăng ký</Label>
                    <Divider />
